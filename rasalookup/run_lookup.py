# see https://github.com/RasaHQ/rasa_lookup_demo
...
def run_demo(key):
    ...
    config_baseline = 'config/config_no_features.yaml'
...
def plot_metrics(metric_list, key, save_path=None):
